...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <meta charset="utf-8">
      ...
      {{-- <script src="{{ asset('js/map_3.js') }}"></script> --}}
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCMDx-ejfVStxIBhfqtBuLj98OV79kqbdY&callback=initMap"></script>
