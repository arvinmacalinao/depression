...
<div class="card">
    <div class="card-header">                  
        <div class="pull-right">
            <a class="projectdetails-btn" href="{{ route('New Project documentation', ['id' => $project->prj_id]) }}" title="Edit"><span class="fa fa-plus"></span> Add Document</a>
        </div>
            ...
            <form action="" method="GET" autocomplete="off">
                <div class="form-row">
                    ...
                    <div class="col-sm-auto mb-2">
                        <div class="input-group input-group-sm">
                            <input class="form-control input-sm" placeholder="Filename..." type="text" maxlength="255" name="qsearch" id="qsearch" value="{{ old('search', $doc_search) }}">
