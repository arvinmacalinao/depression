...
class ProjectProgressTarget extends Model
{
    protected $table = 'psi_project_progress_report_targets';
    const CREATED_AT = 'date_encoded';
    const UPDATED_AT = 'last_updated';
    protected $primaryKey = 'prjprogtarget_id';
    protected $fillable = ['prjprogtarget_target', 'prjprogtarget_category', 'prjprogtarget_parent', 'prjprogtarget_order', 'prj_id', 'region_id', 'synched', 'sync_date', 'date_encoded', 'last_updated', 'encoder', 'updater', 'deleted_at'];
