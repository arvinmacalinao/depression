...
class ProjectAlbumPhotoController extends Controller
{
    public function index($id, $pack_id)
    {
        $project = PsiProject::FindorFail($id);
        $album = ProjectAlbum::FindorFail($album_id);
        $photos = ProjectAlbumPhoto::get();
    
        return view('./projects/details/Packaging/Design/index', compact('project', 'album', 'photos'));    
    }
